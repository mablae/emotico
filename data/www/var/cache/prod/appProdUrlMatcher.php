...
class appProdUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/emotico')) {
            ...
            if (preg_match('#^/emotico/(?P<Id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/users')) {
            ...
            if ($pathinfo === '/users') {
                ...
                return array (  '_controller' => 'ApiBundle\\Controller\\UsersController::getUsersAction',  '_format' => 'json',  '_route' => 'get_users',);
            }
            not_get_users:
            ...
            if (preg_match('#^/users/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_user')), array (  '_controller' => 'ApiBundle\\Controller\\UsersController::getUserAction',  '_format' => 'json',));
            }
            not_get_user:
            ...
            if ($pathinfo === '/users') {
                ...
                return array (  '_controller' => 'ApiBundle\\Controller\\UsersController::postUserAction',  '_format' => 'json',  '_route' => 'post_user',);
            }
            not_post_user:

            // get_user_comments
            if (preg_match('#^/users/(?P<id>[^/]++)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_get_user_comments;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_user_comments')), array (  '_controller' => 'ApiBundle\\Controller\\CommentsController::getCommentsAction',  '_format' => 'json',));
            }
            not_get_user_comments:

            // post_user_comments
            if (preg_match('#^/users/(?P<id>[^/]++)/comments$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_post_user_comments;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'post_user_comments')), array (  '_controller' => 'ApiBundle\\Controller\\CommentsController::postCommentsAction',  '_format' => 'json',));
            }
            not_post_user_comments:
